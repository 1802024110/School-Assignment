...
const (
	...
	RealWorld_MyRpc_FullMethodName    = "/realworld.v1.RealWorld/MyRpc"
)
...
type RealWorldClient interface {
	...
	MyRpc(ctx context.Context, in *NullRequest, opts ...grpc.CallOption) (*NullReply, error)
}
...
func (c *realWorldClient) MyRpc(ctx context.Context, in *NullRequest, opts ...grpc.CallOption) (*NullReply, error) {
	out := new(NullReply)
	err := c.cc.Invoke(ctx, RealWorld_MyRpc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRealWorldServer) MyRpc(context.Context, *NullRequest) (*NullReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MyRpc not implemented")
}
...
func _RealWorld_MyRpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NullRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealWorldServer).MyRpc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RealWorld_MyRpc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).MyRpc(ctx, req.(*NullRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RealWorld_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MyRpc",
			Handler:    _RealWorld_MyRpc_Handler,
		},
	},
