              ...
              <ul class="navbar-nav">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        ...
                        <div class="dropend">
                          <a class="dropdown-item dropdown-toggle" href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">卡片<span class="badge badge-sm bg-green text-uppercase ms-2">新</span>
                          </a>
                          <div class="dropdown-menu">
                      ...
                      <div class="dropdown-menu-column">
                        ...
                        <div class="dropend">
                          <a class="dropdown-item dropdown-toggle" href="#sidebar-authentication" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">认证</a>
                          <div class="dropdown-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./form-elements.html">
                    ...
                    <span class="nav-link-title">表单元素</span>
                  </a>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        ...
                        <a class="dropdown-item" href="./layout-vertical-transparent.html">垂直透明</a>
...
自<strong>打开</strong> 截至 <strong>关闭</strong>.
                          ...
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                <div class="text-truncate">
                                  <strong>撒切尔·基尔</strong>创建了个人资料。</div>
...
委托方</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="flag flag-country-pl"></span>普林蒂奇</td>
                          <td>87956621</td>
                          <td>2018年1月29日</td>
                          <td>
